            ...
            <ul class="navbar-nav navbar-right w-100-p justify-content-end">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img alt="image" src="<?php echo e(asset('uploads/'.Auth::guard('admin')->user()->photo)); ?>" class="rounded-circle">
                        <div class="d-sm-none d-lg-inline-block"><?php echo e(Auth::guard('admin')->user()->name); ?></div>
                    </a>
                    
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo e(route('admin_profile')); ?>"><i class="far fa-user"></i> Edit Profile</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('admin_logout')); ?>"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                    </ul>

                </li>
            </ul>
        </nav><?php /**PATH D:\laragon\www\news_portal_project\resources\views/admin/layout/nav.blade.php ENDPATH**/ ?>