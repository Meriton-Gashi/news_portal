...
<div class="page-top">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2><?php echo e(ALL_POSTS_OF_TAG); ?> <?php echo e($tag_name); ?></h2>
                <nav class="breadcrumb-container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e($tag_name); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-lg-8 col-md-6">
                ...
                <div class="category-page">
                    <div class="row">
                        ...
                        <?php if(!in_array($item->id,$all_post_ids)): ?>
                            <?php continue; ?>
                        <?php endif; ?>
