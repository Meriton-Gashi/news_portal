...
<?php $__env->startSection('heading', 'Add Author'); ?>
...
<div class="section-body">
    <form action="<?php echo e(route('admin_author_store')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-6">
                <div class="card">
