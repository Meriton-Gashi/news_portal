...
<a href="<?php echo e(route('admin_category_create')); ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($row->category_order); ?></td>
