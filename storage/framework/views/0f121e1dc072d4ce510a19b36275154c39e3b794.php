...
<?php $__env->startSection('heading', 'Photos'); ?>

<?php $__env->startSection('button'); ?>
<a href="<?php echo e(route('admin_photo_create')); ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo e(asset('uploads/'.$row->photo)); ?>" alt="" style="width:200px;">
                                    </td>
